...
config =
  defaultConfig
    { -- appearance
      ...
      commands =
        [ -- cpu activity monitor
          Run $
            MultiCpu
              [ "--template",
                "<box type=Bottom width=4 color=" ++ color1 ++ "> <fn=1>\xf108</fn> <total>% </box>",
                "--Low",
                "50", -- units: %
                "--High",
                "85", -- units: %
          ...
          Run $
            MultiCoreTemp
              [ "--template",
                "<box type=Bottom width=4 color=" ++ color3 ++ "> <fn=1>🌡</fn> <avg>°C </box>",
                "--Low",
                "70", -- units: °C
                "--High",
                "80", -- units: °C
          ...
          Run $
            Memory
              [ "--template",
                "<box type=Bottom width=4 color=" ++ color4 ++ "> <fn=1>\xf233</fn> <usedratio>% </box>",
                "--Low",
                "20", -- units: %
                "--High",
                "90", -- units: %
          ...
          Run $
            Battery
              [ "--template",
                "<box type=Bottom width=4 color=" ++ color5 ++ "> <fn=1>\xf242</fn> <acstatus>% </box>",
                "--Low",
                "15", -- units: %
                "--High",
                "75", -- units: %
      ...
      template = " <icon=arch.xpm/> <fc=#666666>|</fc> %XMonadLog% } %date% { %multicpu%  %multicoretemp%  %memory%  %battery% "
    }
